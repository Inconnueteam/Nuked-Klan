...
function affich_block_quiestla($blok){

$nb = nbvisiteur();
if ($nb[0]>1) {$visiteurs = 'S';} else {$visiteurs = '';}
if ($nb[1]>1) {$membres = 'S';} else {$membres = '';}
if ($nb[2]>1) {$admin = 'S';} else {$admin = '';}

		$blok['content'] = '<table width="100%" style="font-size: 80% !important;">
				<tbody><tr>
					<td width="33%" style="text-align:center; font-size: 300%; font-weight: 600; color:#9A9A9A;"><span class="visiteurs">'.$nb[0].'</span></td>
					<td width="33%" style="text-align:center; font-size: 300%; font-weight: 600; color:rgb(139, 197, 63);"><span class="membres">'.$nb[1].'</span></td>
					<td width="33%" style="text-align:center; font-size: 300%; font-weight: 600; color:rgb(98, 167, 227);"><span class="admins">'.$nb[2].'</span></td>
				</tr> 
					<tr>
					<td style="text-align:center;font-weight: 600; color:#9A9A9A;">VISITEUR'.$visiteurs.'</td>
					<td style="text-align:center;font-weight: 600; color:rgb(139, 197, 63);">MEMBRE'.$membres.'</td>
					<td style="text-align:center;font-weight: 600; color:rgb(98, 167, 227);">ADMIN'.$admin.'</td>
				</tr>
				</tbody>
		</table>';
...
function edit_block_quiestla($bid){
